...
jQuery(document).ready(function () {
        ...
        if (typeof th !== "undefined") {
            ...
            if (typeof field !== "undefined") {
                ...
                field
                    ...
                    .replaceWith(
                        '<input type="text" class="customizer-repeater-color-control ' + id + '">'
                    );
                ...
                field
                    ...
                    .replaceWith(
                        '<input type="text" class="customizer-repeater-color2-control ' + id + '">'
                    );
    ...
    theme_conrols.on("change", ".customizer-repeater-social-repeater-container .icp", function (
        event
    ) {
        event.preventDefault();
