 ...
 */
function pel_convertDecimalToDMS($degree)
{
 ...
 */
//function pel_addGpsInfo($input, $output, $description, $comment, $model, $longitude, $latitude, $altitude, $date_time)
function pel_addGpsInfo($input, $output, $description, $comment, $longitude, $latitude)
{
    $altitude = 0;
     ...
     */
    list ($hours, $minutes, $seconds) = pel_convertDecimalToDMS($latitude);
    ...
    list ($hours, $minutes, $seconds) = pel_convertDecimalToDMS($longitude);
